...
public class MessageJson implements Serializable {
    ...
    public MessageJson(String messageName, String imagePathname, double itemHeight, String upcList, double itemLength, String command, String itemName, String pickType, double itemWidth, String rfidTagged, String itemDescription, int storageAttribute, double itemWeight, OrderStatus orderStatus) {
